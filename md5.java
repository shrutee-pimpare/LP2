...
class md5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the text to compute MD5: ");
        String text = scanner.nextLine();

        byte[] md5Hash = computeMD5(text.getBytes());
        System.out.println("MD5 Hash: " + toHexString(md5Hash));
